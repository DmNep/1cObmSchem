Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "1с_ObmShem построитель схем обменов"); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
	...
	НовСтрока.Идентификатор = "1с_ObmShem построитель схем обменов";
	НовСтрока.Использование = "ОткрытиеФормы";
	НовСтрока.Представление = "1с_ObmShem построитель схем обменов";
